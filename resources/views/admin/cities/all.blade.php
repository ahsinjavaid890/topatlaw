                ...
                <table id="basic-datatable" class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$r->tittle}}</td>
                        <td><?php echo DB::table('categories')->where('status' , 1)->where('id', $r->serviceid)->first()->tittle; ?></td>
                        <td style="text-align: center;">
                          <a href="{{ url('admin/editcity') }}/{{ $r->id }}">
                            <button class="btn btn-sm btn-primary">Edit</button>
                          </a>
                          <a onclick="return confirm('Are You Sure You want to Delete This')" href="{{ url('admin/deletecity') }}/{{ $r->id }}">
