...
<div class="container-fluid">
  ...
  <div class="row">
      <div class="col-12">
          <div class="page-title-box">
              ...
              <h4 class="page-title">Edit City <b>{{ $data->tittle }}</b></h4>
          </div>
      </div>
  </div>
  <!-- end page title -->
  ...
  <div class="row">
      ...
      <div class="col-lg-6">
          <div class="card">
              <div class="card-body">
                  ...
                  <form method="post" action="{{ url('updatecity') }}" enctype="multipart/form-data" class="needs-validation" novalidate>
                     {{ csrf_field() }}
                     <input type="hidden" value="{{ $data->id }}" name="id">
                      ...
                      <div class="form-group mb-3">
                          ...
                          <textarea id="validationCustom02" name="description" class="form-control" placeholder="Enter Short Description" id="shortdescription" rows="10" >{{ $data->description }}</textarea>
                          <div class="valid-feedback">
                              Looks good!
                          </div>
                      </div>
      ...
      <div class="col-lg-6">
          <div class="card">
              <div class="card-body">
                  <h4 class="header-title">City Tumbnail Image</h4>
                  <div class="row">
                      <div class="col-lg-6 col-md-12">
                          <form method="post" action="{{ url('updatecitythumbnail') }}" enctype="multipart/form-data" class="needs-validation" novalidate>
                             {{ csrf_field() }}
                             <input type="hidden" value="{{ $data->id }}" name="id">
                              <div class="form-group mb-3">
                              ...
                              <button class="btn btn-primary" type="submit">Update City Thumbnail</button>
                          </form> 
                      </div>
